...
class Registro_Estudiantes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvTitle.text = "Registro de Estudiantes"
    ...
    private fun ValidarInformacion() {
        ...
        // Validaciones
        if (rol.isEmpty() || !listOf("Estudiante").contains(rol)) {
    ...
    private fun AgregarInfoFirestore() {
        ...
        firestore.collection("usuarios").document(uid)
            ...
            .addOnSuccessListener {
                ...
                intent.putExtra("fragmentToLoad", "Fragment_admin_estudiantes")
